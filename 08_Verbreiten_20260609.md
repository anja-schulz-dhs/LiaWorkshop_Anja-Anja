...
- **Tag-basierte Stabilität:** Wenn Sie auf einen *Tag* statt auf `main` verlinken (siehe [Phase 3, `import:`](03_Workshop_20260609_Verstehen.md)), bekommen Lernende eine eingefrorene Fassung — auch wenn Sie parallel weiterarbeiten.
