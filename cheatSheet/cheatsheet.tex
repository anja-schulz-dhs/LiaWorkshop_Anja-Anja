...
\begin{liacard}{YAML-Header\aufl{1}}
\begin{lstlisting}[language=lia]
<!--
author:   Maria Muster
language: de
...
\begin{liacard}{Medien abspielbar\aufl{2}}
\begin{lstlisting}[language=lia]
...
\begin{liacard}{Eingebettete Ressource\aufl{3}}
\begin{lstlisting}[language=lia]
...
\begin{liacard}{Animation \& Click-Reveal\aufl{4}}
\begin{lstlisting}[language=lia]
Sofort sichtbar.
...
\begin{liacard}{Sprecher-Text (TTS)\aufl{5}}
\begin{lstlisting}[language=lia]
## Folie
         --{{0}}--
...
\begin{liacard}{Quiz: Freitext\aufl{6}}
\begin{lstlisting}[language=lia]
...
\begin{liacard}{Quiz: Single-Choice\aufl{7}}
\begin{lstlisting}[language=lia]
- [( )] falsch
- [(X)] richtig
- [[?]] Hinweis
...
\begin{liacard}{Quiz: Multiple-Choice\aufl{8}}
\begin{lstlisting}[language=lia]
...
\begin{liacard}{Diagramme (Mermaid)\aufl{9}}
\begin{lstlisting}[language=lia]
```mermaid @mermaid
graph TD
A --> B((OR))
...
\begin{liacard}{Zitation \& BibTeX\aufl{10}}
\begin{lstlisting}[language=lia]
...
\begin{liacard}{Code ausführen\aufl{11}}
\begin{lstlisting}[language=lia]
```python
zahlen = [1,2,3,4,5]
print(sum(zahlen))
