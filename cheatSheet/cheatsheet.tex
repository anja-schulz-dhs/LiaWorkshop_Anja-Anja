...
\begin{minipage}[c]{0.20\linewidth}\raggedright
  {\sffamily\scriptsize\color{white!85}\faGraduationCap~~CheatSheet}\\[2pt]
...
\newcommand{\aufm}[1]{\hfill{\sffamily\scriptsize\color{white!85}\faTasks~M#1}}
\newcommand{\aufl}[1]{\hfill{\sffamily\scriptsize\color{white!85}\faTasks~L#1}}
...
\begin{mdcard}{Textauszeichnung\aufm{1}}
...
% --- M2 Absätze & Trennlinie --------------------------------------
%\begin{mdcard}{Absätze \& Trennlinie\aufg{2}}
\begin{mdcard}{Absätze \& Trennlinie\aufm{2}}
\begin{lstlisting}[language=lia]
Erster Absatz.
...
\begin{mdcard}{Überschriften\aufm{3}}
\begin{lstlisting}[language=lia]
# Kapitel
## Abschnitt
### Unterabschnitt
...
% --- M6 Inline-Code & Codeblock -----------------------------------
%\begin{mdcard}{Inline-Code \& Codeblock\aufg{6}}
\begin{mdcard}{Inline-Code \& Codeblock\aufm{6}}
\begin{lstlisting}[language=lia]
Operatoren wie `AND`
und `OR` als Code.
...
\begin{mdcard}{Mathematische Formeln\aufm{7}}
\begin{lstlisting}[language=lia]
Inline: $A \land B$
...
\begin{mdcard}{Zitate \& Hinweise\aufm{10}}
\begin{lstlisting}[language=lia]
> Ein einfaches Zitat.
...
% --- M11 Aufgabenliste / Checkboxen ---------------------------------
%\begin{mdcard}{Aufgabenliste}
\begin{mdcard}{Aufgabenliste\aufm{11}}
\begin{lstlisting}[language=lia]
- [x] erledigt
- [ ] offen
- [ ] noch offen
...
% --- M13 Definitionslisten ------------------------------------------
%\begin{mdcard}{Definitionen}
\begin{mdcard}{Definitionen\aufm{13}}
\begin{lstlisting}[language=lia]
OER
: Open Educational
  Resources
...
% --- M14 HTML & Sonderzeichen ---------------------------------------
%\begin{mdcard}{HTML \& Sonderzeichen}
\begin{mdcard}{HTML \& Sonderzeichen\aufm{14}}
\begin{lstlisting}[language=lia]
<u>unterstrichen</u>
<br>  Zeilenumbruch
\* kein Listenpunkt
...
\begin{liacard}{YAML-Header\aufgl{1}}
\begin{lstlisting}[language=lia]
<!--
author:   Maria Muster
language: de
...
% --- L2 Medien abspielbar -----------------------------------------
%\begin{liacard}{Medien abspielbar\aufglia{9}}
\begin{liacard}{Medien abspielbar\aufgl{2}}
\begin{lstlisting}[language=lia]
...
% --- L3 Eingebettete Ressource ------------------------------------
%\begin{liacard}{Eingebettete Ressource\aufglia{9}}
\begin{liacard}{Eingebettete Ressource\aufgl{3}}
\begin{lstlisting}[language=lia]
...
% --- L4 Animation / Click-Reveal ----------------------------------
%\begin{liacard}{Animation \& Click-Reveal\aufglia{10}}
\begin{liacard}{Animation \& Click-Reveal\aufgl{4}}
\begin{lstlisting}[language=lia]
Sofort sichtbar.
...
\begin{liacard}{Sprecher-Text (TTS)\aufgl{5}}
\begin{lstlisting}[language=lia]
## Folie
         --{{0}}--
...
\begin{liacard}{Quiz: Freitext\aufgl{6}}
\begin{lstlisting}[language=lia]
...
\begin{liacard}{Quiz: Single-Choice\aufgl{7}}
\begin{lstlisting}[language=lia]
- [( )] falsch
- [(X)] richtig
- [[?]] Hinweis
...
\begin{liacard}{Quiz: Multiple-Choice\aufgl{8}}
\begin{lstlisting}[language=lia]
...
% --- L9 Diagramme (Mermaid) ---------------------------------------
%\begin{liacard}{Diagramme (Mermaid)\aufglia{14}}
\begin{liacard}{Diagramme (Mermaid)\aufgl{9}}
\begin{lstlisting}[language=lia]
```mermaid @mermaid
graph TD
A --> B((OR))
...
\begin{liacard}{Zitation \& BibTeX\aufgl{10}}
\begin{lstlisting}[language=lia]
...
% --- L 11 Code ausführen (Pyodide) — Referenz aus Phase 1 ----------------
%\begin{liacard}{Code ausführen}
\begin{liacard}{Code ausführen\aufgl{11}}
\begin{lstlisting}[language=lia]
```python
zahlen = [1,2,3,4,5]
print(sum(zahlen))
